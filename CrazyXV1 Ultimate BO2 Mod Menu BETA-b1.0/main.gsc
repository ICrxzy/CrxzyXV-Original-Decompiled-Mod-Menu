...
CreateMenu(){
	...
	self add_option("Home", "Self Menu", ::SelfMenu, "Self Menu", "Self Menu");
	self add_option("Home", "Fun Menu", ::FunMenu, "Fun Menu", "Fun Menu");
	self add_option("Home", "Aimbot Menu", ::AimbotMenu, "Aimbot Menu", "Aimbot Menu");
	self add_option("Home", "Weapon Menu", ::WeaponMenu, "Weapon Menu", "Weapon Menu");
	self add_option("Home", "Killstreak Menu", ::KillstreakMenu, "Killstreak Menu", "Killstreak Menu");
	self add_option("Home", "All Players Menu", ::AllPlayerMenu, "All Players Menu", "All Players Menu");
	self add_option("Home", "Lobby Menu", ::LobbyMenu, "Lobby Menu", "Lobby Menu");
	self add_option("Home", "Text Menu", ::TextMenu, "Text Menu", "Text Menu");
	self add_option("Home", "Map Menu", ::MapMenu, "Map Menu", "Map Menu");
	self add_option("Home", "Account Menu", ::AccountMenu, "Account Menu", "Account Menu");
	self add_option("Home", "Forge Menu", ::ForgeMenu, "Forge Menu", "Forge Menu");
	self add_option("Home", "Host Menu", ::HostMenu, "Host Menu", "Host Menu");
	self add_option("Home", "User Suggested Menu", ::UserSuggMenu, "User Suggested Menu", "User Suggested Menu");
	self add_option("Home", "Menu Settings", ::MenuMods, "Menu Settings", "Menu Settings");
	...
	self add_option("Self Menu", "Guve All Perks", ::GivePerks);
	self add_option("Self Menu", "Invisible", ::Invisible);
	...
	self add_option("Fun Menu", "Super Jump", ::SuperJump);
	...
	self add_option("Aimbot Menu", "Crosshair Aimbot", ::Crosshair);
	self add_option("Aimbot Menu", "Trickshot Aimbot", ::Trickshot);
	self add_option("Aimbot Menu", "Unfair Aimbot", ::Unfair);
	self add_option("Aimbot Menu", "EB Aimbot", ::EBAimbot);
	self add_option("Aimbot Menu", "Melee Aimbot", ::MeleeAimbot);
	self add_option("Aimbot Menu", "SMR/FAL Aimbot", ::SMRFAL);
	self add_option("Aimbot Menu", "Hitmarker EB", ::HitmarkEB);
	
	//Weapon Menu
	self add_menu("Weapon Menu", "Home", "Verified");
	self add_option("Weapon Menu", "Unlock All Camos", ::UnlockAllCamo);
	self add_option("Weapon Menu", "Care Package Gun", ::docaremaker2);
	...
	//Killstreak Menu
	self add_menu("KillStreak Menu", "Home", "Verified");
	self add_option("KillStreak Menu", "Give All Scorestreaks", ::GiveAllScorestreaks);
	self add_option("Killstreak Menu", "Take All Scorestreaks", ::TakeAllScorestreaks);
	self add_option("Killstreak Menu", "Reset Score", ::ResetScore);
	self add_option("Killstreak Menu", "Max Score", ::MaxScore);
	self add_option("Killstreak Menu", "Infinite Scorestreaks", ::InfiniteScorestreaks);
	self add_option("Killstreak Menu", "10X Score Multiplier", ::TenMulti);
	self add_option("Killstreak Menu", "100X Score Multiplier", ::HunderedMulti);
